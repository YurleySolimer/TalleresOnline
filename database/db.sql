...
CREATE TABLE locales (
	...
	CONSTRAINT fk_medio FOREIGN KEY  (medioPago_id) REFERENCES medios(id)

);

DESCRIBE locales;

CREATE TABLE medioLocal (
	id INT (11),
    medio_id INT (11),
    local_id INT (11)
...
CREATE TABLE firmas (
	id INT (11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
	firma_url VARCHAR(250)

);

CREATE TABLE marcaLocal (
	id INT (11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
	marca_id INT (11),
	local_id INT (11),
	CONSTRAINT fk_marca2 FOREIGN KEY  (marca_id) REFERENCES marcasVehiculos(id),
	CONSTRAINT fk_local2 FOREIGN KEY  (local_id) REFERENCES locales(id)
);

DESCRIBE marcaLocal;

CREATE TABLE servicioLocal (
	id INT (11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
	servicio_id INT (11),
	local_id INT (11),
	CONSTRAINT fk_servicio2 FOREIGN KEY  (servicio_id) REFERENCES categorias(id),
	CONSTRAINT fk_local3 FOREIGN KEY  (local_id) REFERENCES locales(id)
);


DESCRIBE servicioLocal;
...
INSERT INTO marcasVehiculos (marca) VALUES('Abarth'), ('Alfa Romeo'), ('Alpina'), ('Aston Martin'), ('Audi'), ('Barkas');
INSERT INTO marcasVehiculos (marca) VALUES('Bentley'), ('BMW'), ('Cadillac'), ('Caterham'), ('Chevrolet'), ('Chrysler');
INSERT INTO marcasVehiculos (marca) VALUES('Citroen'), ('Corvette'), ('Cupra'), ('Dacia'), ('Daewoo'), ('Daihatsy');
INSERT INTO marcasVehiculos (marca) VALUES('Dodge'), ('DS Automobiles'), ('Fiat'), ('Ford'), ('Honda'), ('Hyundai');
INSERT INTO marcasVehiculos (marca) VALUES('Infiniti'), ('Isuzu'), ('Iveco'), ('Jaguar'), ('Jeep'), ('Kia');
INSERT INTO marcasVehiculos (marca) VALUES('Lada'), ('Lancia'), ('Land Rover'), ('Lexus'), ('Lotus'), ('MAN');
INSERT INTO marcasVehiculos (marca) VALUES('Meserati'), ('Mazda'), ('Mercedes Benz'), ('MG Rover'), ('MINI'), ('Mitsubishi');
INSERT INTO marcasVehiculos (marca) VALUES('Nissan'), ('Opel'), ('Peugeot'), ('Piaggio'), ('Pontiac'), ('Porsche');
INSERT INTO marcasVehiculos (marca) VALUES('Renault'), ('Rover'), ('Saab'), ('Seat'), ('Skoda'), ('Smart');
INSERT INTO marcasVehiculos (marca) VALUES('Ssangyong'), ('Subaru'), ('Suzuki'), ('Tata'), ('Tesla'), ('Toyota');
INSERT INTO marcasVehiculos (marca) VALUES('Volkswagen'), ('Volvo'), ('Westfiel'), ('Otro');

INSERT INTO categorias (categoria) VALUES('Carwash & detailing'), ('Lubricentro'), ('Venta de accesorios'), ('Mecanica Automotriz'), ('Venta de Repuestos'), ('Otro');
INSERT INTO medios (medio) VALUES('Efectivo'), ('Transferencia'), ('Visa'), ('Mastercard');
...
ALTER TABLE carros
	MODIFY kilometraja ENUM ('Kilometros', 'Millas') DEFAULT 'Kilometros';


ALTER TABLE ot
	ADD categoria_id INT (11);

ALTER TABLE ot	
	ADD CONSTRAINT fk_categoria3 FOREIGN KEY  (categoria_id) REFERENCES categorias(id);
...
SELECT ot.subtotal, ot.iva, ot.total, ot.fecha_recepcion, ot.numero, ot.estado, ot.id_local, ot.facturada, ot.id as otid,
...
JOIN categorias ca on ot.categoria_id = ca.id
...
CREATE VIEW vistaEstado AS 
	SELECT o.numero, o.estado, o.fecha_recepcion, o.categoria_id, o.id, o.id_local,
		   v.placa, v.modelo, 
		   c.nombre,
		   l.user_id
	FROM ot o 
...
CREATE VIEW resumenUser AS
	SELECT o.id, o.subtotal, o.iva, o.total, o.fecha_recepcion, o.id_local,
		   o.numero, o.categoria_id, o.estado,
		   u.id as userId
	FROM ot o
	JOIN locales l on l.id = o.id_local
...
select ot.total, c.categoria
from ot
join categorias c on c.id = ot.categoria_id
;
...
SELECT ot.subtotal, ot.iva, ot.total, ot.fecha_recepcion, ot.numero, ot.estado, ot.id_local,
	   c.nombre, c.correo, c.distrito, c.tlf, c.fecha_nacimiento, c.genero, c.conocio_carhelp,
       ct.tipo_cliente, ca.categoria,
	   	l.user_id
...
SELECT l.nombreLocal, l.direccion, l.distrito, l.telefono, l.user_id, l.categoria_id, l.horarioEntrada, l.horarioSalida, 
