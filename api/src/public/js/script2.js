...
let daihatsu = new Array(
  'Applause',
  'Hi Jet S 76 4WD /Piaggio Porter',
  'Hijet',
  'Sirion',
  'Sparcar S 75',
  'Terios'
...
function modelo() {
  ...
  model =
    document.formOT.marcaCarro[document.formOT.marcaCarro.selectedIndex].id
...
function modeloProforma() {
  ...
  //captar modelo segun la marca
  model =
    document.formProforma.marcaCarro[
      document.formProforma.marcaCarro.selectedIndex
    ].id
  //definir si existen modelos para la marca
  if (model != 'none') {
    mis_modelos = eval(model)
...
function agregarInput() {
  ...
  var detalleDiv = document
    .getElementById('input-dinamico')
